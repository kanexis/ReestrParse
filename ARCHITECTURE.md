...
> Технический разбор архитектуры WPF-приложения для сбора реестров ФГИС ЕИАС, обхода динамической DevExpress-пагинации и параллельного извлечения контактных данных из формы 4.1.1.
